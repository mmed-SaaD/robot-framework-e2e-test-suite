...
export const options = {
    ...
    thresholds: {
        ...
        'http_req_duration{type:search}': ['p(95)<6000'],
        'http_req_duration{type:auth}': ['p(95)<8000'],
        'http_req_duration{type:basket}': ['p(95)<10000'],
        'http_req_duration{type:feedback}': ['p(95)<10000'],
    }
};
